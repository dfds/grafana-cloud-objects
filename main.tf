...
module "ce_folder" {
  ...
  source = "git::https://github.com/dfds/terraform-grafana-cloud.git//grafana_folder?ref=2.3.2"
...
module "dashboards" {
  ...
  source = "git::https://github.com/dfds/terraform-grafana-cloud.git//grafana_dashboard?ref=2.3.2"
...
module "alerts" {
  ...
  source = "git::https://github.com/dfds/terraform-grafana-cloud.git//grafana_alert?ref=2.3.2"
...
module "grafana_data_source_aws_athena" {
  ...
  source = "git::https://github.com/dfds/terraform-grafana-cloud.git//grafana_data_source_athena?ref=2.3.2"
...
module "grafana_data_source_aws_cloudwatch" {
  ...
  source = "git::https://github.com/dfds/terraform-grafana-cloud.git//grafana_data_source_cloudwatch?ref=2.3.2"
...
module "grafana_data_source_infinity" {
  ...
  source = "git::https://github.com/dfds/terraform-grafana-cloud.git//grafana_data_source_infinity?ref=2.3.2"
...
module "grafana_notification" {
  ...
  source = "git::https://github.com/dfds/terraform-grafana-cloud.git//grafana_notification?ref=2.3.2"
